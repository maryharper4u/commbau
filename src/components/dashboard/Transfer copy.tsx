...
//                 <Link href="/dashboard"
//                   className="max-w-max flex items-center justify-center rounded-full mt-4 px-4 min-h-[50px] text-xl bg-[#aa8406] text-white"
//                 >
//                   Cancel
//                 </Link>
//                 <button
//                   type="button"
//                   className="w-full rounded-full mt-4 px-4 min-h-[50px] text-xl bg-[#aa8406] text-white"
//                   onClick={handleNext}
//                 >
//                   Next
//                 </button>
...
//                   <div className="rounded-lg flex items-center justify-center w-[35px] h-[35px] bg-[#aa8406] text-white">
//                     WF
//                   </div>
